...
animal.innerHTML = '<img src="assets/images/3-D-avatar_priyam.png" alt="My 3D Character" style="width: 60px; height: 60px; object-fit: contain; filter: drop-shadow(0 0 12px #64ffda); transition: transform 0.1s; transform-origin: center;">'; // Neon glow cursor follower!
